...
const Navbar = () => {
  ...
  return (
    <div className=' h-18 max-w-[1024px] mx-auto text-white flex justify-between items-center p-4 '>
    <h1 className='font-extrabold  text-3xl text-[#00df9a] w-100'>REACT.</h1>
    ...
    { !nav? <FaBars className='text-3xl text-white' />: <FaWindowClose className='text-3xl text-white' />}
    </div>

   

    <div className={nav ? 'fixed top-0 left-0 h-full w-80 bg-gray-700 p-4 duration-500 ease-in-out':'fixed left-[-200%]'}>
     <h1 className='font-extrabold  text-3xl text-[#00df9a] w-100 mb-6'>REACT. </h1>
        <ul >
